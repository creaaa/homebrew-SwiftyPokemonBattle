...
//        print("結果: \(battleField.battleFieldPokemonArray[turnNo].statusChange.index(of: TypeWriterOutput.StatusChange.destinyBond(1)))")
        ...
        if battleField.battleFieldPokemonArray[turnNo].statusChange.index(of: StatusChange.destinyBond(1)) == nil {
            //print("みちづれ状態 追加だよ！")
            ...
            // MARK: ここ　超あやしい！
            let idx = battleField.battleFieldPokemonArray[turnNo].statusChange.index(of: StatusChange.destinyBond(1))
    ...
    func yawn() {
        ...
        if battleField.battleFieldPokemonArray[turnNo.hantenInt].statusChange.index(of: StatusChange.yawn(99999)) == nil {
...
//            print("ひるみは 後攻だと 発生しない！")
        ...
        if battleField.battleFieldPokemonArray[turnNo.hantenInt].statusChange.index(of: StatusChange.flinch) == nil {
